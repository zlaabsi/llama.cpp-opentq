...
GGML_API void dequantize_row_opentq_tq3_sb4(const block_opentq_tq3_sb4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_opentq_tq4_sb2(const block_opentq_tq4_sb2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_opentq_tq4_sb4(const block_opentq_tq4_sb4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_opentq_tq4r2(const block_opentq_tq4r2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_opentq_tq4r4(const block_opentq_tq4r4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
